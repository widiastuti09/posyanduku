              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{$regbal->ibu->user->nik}} - {{$regbal->ibu->nama}}" disabled>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control select2" name="jeniskelamin" style="width: 100%;">
                      ...
                      <option @if($regbal->jeniskelamin == 'Laki-laki') 'selected' @endif>Laki-laki</option>
                      <option @if($regbal->jeniskelamin == 'Perempuan') 'selected' @endif>Perempuan</option>
                    </select>
                  </div>
                  <div class="form-group">
