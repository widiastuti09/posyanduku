            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="namabalita" name="namabalita" placeholder="Masukkan Nama">
                </div>
                <div class="form-group">
                    <label>Tempat Lahir</label>
                    <input type="text" class="form-control" id="tempatlahir" name="tempatlahir" placeholder="Masukkan Nama">
                </div>
                <div class="form-group">
                    <label>Tanggal Lahir</label>
                    <input type="date" class="form-control" id="tanggallahir" name="tanggallahir" placeholder="Masukkan Nama">
                </div>
                <div class="form-group">
              ...
              <div class="col-md-6 ">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="usia" name="usia" placeholder="Masukkan Usia Anak">
                </div>
                <div class="form-group">
                    <label>Berat Badan Lahir (Kg)</label>
                    <input type="number" class="form-control" id="bblahir" name="bblahir" placeholder="Masukkan Berat Badan Anak">
                </div>
                <div class="form-group">
                    <label>Panjang Badan Lahir (Cm)</label>
                    <input type="number" class="form-control" id="pblahir" name="pblahir" placeholder="Masukkan Panjamg Badan Anak">
                </div>
                <div class="form-group">
                    <label>No KK Balita</label>
                    <input type="number" class="form-control" id="nokk" name="nokk" placeholder="Masukkan Nomor KK">
                </div>
                <div class="form-group">
                    <label>No NIK Balita</label>
                    <input type="number" class="form-control" id="nikbalita" name="nikbalita" placeholder="Masukkan Nomor NIK">
                </div>
                <div class="form-group">
                    <label>No Telp</label>
                    <input type="number" class="form-control" id="telp" name="telp" placeholder="Masukkan Nomor Telp">
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
