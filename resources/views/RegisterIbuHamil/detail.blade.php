...
<body>
  ...
  <tbody>
    <tr>
        ...
        <td scope="row"  class="font-weight-normal">{{date('d F Y', strtotime($regmil->tglregister))}}</td>
    ...
    <th class="font-weight-bold">Tanggal Lahir</th>
      <td scope="row" class="font-weight-normal">{{date('d F Y', strtotime( $regmil->tgllahir))}}</td>
    ...
    <th class="font-weight-bold">Tinggi Badan</th>
      <td scope="row" class="font-weight-normal">{{$regmil->tinggibadan}}</td>
     
   
    </tr>
    <tr>
    <th class="font-weight-bold">Usia</th></th>
      <td scope="row" class="font-weight-normal">{{$regmil->usia}}</td>
     
   
    </tr>
    <tr>
    <th class="font-weight-bold">Hemoglobin (HB)</th>
      <td scope="row" class="font-weight-normal">{{$regmil->hemoglobin}}</td>
      

    </tr>
    <tr>
    <th class="font-weight-bold">HTP</th>
      <td scope="row" class="font-weight-normal">{{date('d F Y', strtotime($regmil->htp))}}</td>
      
    
    </tr>
    <tr>
    <th class="font-weight-bold">HPTH</th>
      <td scope="row" class="font-weight-normal">{{ date('d F Y',strtotime($regmil->hpht)) }}</td>
      
      
    </tr>
    <tr>
    <th class="font-weight-bold">Berat Badan</th>
      <td scope="row" class="font-weight-normal">{{$regmil->beratbadan}}</td>
      
     
    </tr>
    <tr>
    <th class="font-weight-bold">Hamil Ke (G)</th>
      <td scope="row" class="font-weight-normal">{{$regmil->hamilke}}</td>
      
    
    </tr>
    <tr>
    <th class="font-weight-bold">Persalinan Ke (P)</th>
      <td scope="row" class="font-weight-normal">{{$regmil->persalinanke}}</td>
      
 
    </tr>
    <th class="font-weight-bold">Jumlah Keguguran (A)</th>
      <td scope="row" class="font-weight-normal">{{$regmil->keguguranke}}</td>
