                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td scope="row" class="font-weight-normal">{{ $petugas->name}}</td>
                                </tr>
                                <tr>
                                    <th class="font-weight-bold">Email</th>
                                    <td scope="row" class="font-weight-normal">{{$petugas->email}}</td>
                                </tr>
                                <!-- <tr>
                                    <th class="font-weight-bold">Password</th>
                                    </th>
                                    <td scope="row" class="font-weight-normal">{{$petugas->password}}</td>
                                </tr>
                                <tr>
                                    <th class="font-weight-bold">Level</th>
                                    <td scope="row" class="font-weight-normal">{{$petugas->level}}</td>
                                </tr> -->
